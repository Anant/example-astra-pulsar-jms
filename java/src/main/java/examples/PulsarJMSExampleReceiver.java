...
public class PulsarJMSExampleReceiver extends PulsarJMSExampleApplication {
    // Must be set before initializing the "logger" object.
    private final static String APP_NAME = "PulsarJMSExampleReceiver";
    static { System.setProperty("log_file_base_name", getLogFileName(API_TYPE, APP_NAME)); }
    private final static Logger logger = LoggerFactory.getLogger(PulsarJMSExampleReceiver.class);
    ...
    public PulsarJMSExampleReceiver(String appName, String[] inputParams) {
    ...
    public static void main(String[] args) {
        PulsarJMSExample workshopApp = new PulsarJMSExampleReceiver(APP_NAME, args);
