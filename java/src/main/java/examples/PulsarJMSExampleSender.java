...
public class PulsarJMSExampleSender extends PulsarJMSExampleApplication {
    // Must be set before initializing the "logger" object.
    private final static String APP_NAME = "PulsarJMSExampleSender";
    ...
    public PulsarJMSExampleSender(String appName, String[] inputParams) {
