...
abstract public class PulsarJMSExampleApplication extends PulsarJMSExample {
    protected final static String API_TYPE = "jms-s4j";
    protected int jmsSessionMode = JMSContext.AUTO_ACKNOWLEDGE;

    public PulsarJMSExampleApplication(String appName, String[] inputParams) {
    ...
    public Queue createTempQueueDestination(JMSContext jmsContext, String destName) {
        assert (jmsContext != null);
        assert (StringUtils.isNotBlank(destName));
