...
public class ConfClientConnection {
    private final Map<String, String> clientConfMap = new HashMap<>();

    public ConfClientConnection(File clientConnFile) throws ConfRuntimeException {
        ...
        try {
            ...
            throw new ConfRuntimeException("Can't read the specified properties file!");
        } catch (ConfigurationException cex) {
            throw new ConfRuntimeException(
